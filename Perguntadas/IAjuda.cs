...
public abstract class IAjuda{
    ...
    public void ConfiguraEstruturaDesenho(Button buttonResposta01, Button buttonResposta02, Button buttonResposta03, Button buttonResposta04, Button buttonResposta05)
    {
